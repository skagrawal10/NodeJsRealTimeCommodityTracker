var app = require('http').createServer(handler)
  , io = require('socket.io')(app, {'transports': ['websocket', 'polling']}).listen(app)
  , fs = require('fs')
...
{
	query = "(select * from mcxrates where symbol like '"+ silver_symbol +"%' order by id desc limit 1) union (select * from mcxrates where symbol like '"+ gold_symbol +"%' order by id desc limit 1)";
	//console.log(query);
